...
//3. Write a function calculateTotal(price, quantity, taxRate) that takes the item price, quantity bought, and local tax percentage (e.g., 5 for 5%). The function should calculate and return the final total price after tax.
...
//5. Write a function calculateAgeInDays(ageInYears) that takes a person's age in years and returns their approximate age in days (assume 365 days per year, ignoring leap years).
